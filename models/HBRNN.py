...
class HBRNN:
    class Discriminator(K.models.Model):
        ...
        def berkeley(self, inputs, training=None, mask=None):
            ...
            # 2nd layer
            x2_1 = self.rnn2_1(self.concatenate([x1_1, x1_3]))
            x2_2 = self.rnn2_2(self.concatenate([x1_2, x1_3]))
            x2_3 = self.rnn2_3(self.concatenate([x1_4, x1_3]))
            x2_4 = self.rnn2_4(self.concatenate([x1_5, x1_3]))

            # 3rd layer
            x3_1 = self.rnn3_1(self.concatenate([x2_1, x2_2]))
            x3_2 = self.rnn3_2(self.concatenate([x2_3, x2_4]))

            # 4th layer
            x4_1 = self.rnn4_1(self.concatenate([x3_1, x3_2]))
